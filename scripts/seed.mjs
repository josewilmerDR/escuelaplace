...
/** Build a Location object with geopoint + geohash from lat/lng. All seed data is
 * Costa Rican, so the country code is fixed; admin1/2/3 come in `extra` (the
 * country-agnostic levels — see types/firestore.ts). */
...
const businesses = [
  {
    ...
    // catalog: WhatsApp Business catalog link (renders the "Ver catálogo" button).
